...
public enum Card {
    ...
    Belenus(1, 1, Collections.singletonList(Attribute.HERO), Collections.singletonList(1), 10, null, null),
    ...
    Magni(2, 1, Collections.singletonList(Attribute.HERO), Collections.singletonList(3), 10, null, null),
    Thrudheim_Archers(2, 1, new ArrayList<>(), Collections.singletonList(2), 10, null, null),
    ...
    Kvaser(2, 1, new ArrayList<>(), Collections.singletonList(2), 4, null, null),
    ...
    Axe_Launcher(2, 3, Collections.singletonList(Attribute.BOND), Collections.singletonList(1), 2, null, BondClass.AXE_LAUNCHER),
