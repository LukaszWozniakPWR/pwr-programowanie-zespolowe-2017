...
enum class CardClass(
    ...
    @SerializedName("SNAKE_STORM") SNAKE_STORM(10, RowInfo.CATAPULTS, Fraction.NILFGAARD, listOf(), R.string.snake_storm_card_name, R.string.snake_storm_card_description, R.drawable.ic_dissatisfied_512),
    ...
    @SerializedName("ARCHERS_THRUDHEIM") ARCHERS_THRUDHEIM(10, RowInfo.ARCHERS, Fraction.NILFGAARD, listOf(), R.string.archers_thrudheim_card_name, R.string.archers_thrudheim_card_description, R.drawable.ic_dissatisfied_512),
    ...
    @SerializedName("ARROW_STORM") ARROW_STORM(5, RowInfo.CATAPULTS, Fraction.NILFGAARD, listOf(), R.string.arrow_storm_card_name, R.string.arrow_storm_card_description, R.drawable.ic_dissatisfied_512),
    ...
    @SerializedName("ROCK_STORM") ROCK_STORM(5, RowInfo.CATAPULTS, Fraction.NILFGAARD, listOf(), R.string.rock_storm_card_name, R.string.rock_storm_card_description, R.drawable.ic_dissatisfied_512),
