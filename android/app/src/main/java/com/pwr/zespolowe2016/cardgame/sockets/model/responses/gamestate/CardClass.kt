...
//    @SerializedName("ARCHER") ARCHER(5, RowInfo.ARCHERS, NILFGAARD, listOf(), R.string.nickname_hint, R.string.nickname_incorrect, R.drawable.ic_dissatisfied_512)
    ...
    @SerializedName("IBAR_DRUIDS") IBAR_DRUIDS(5, RowInfo.ARCHERS, Fraction.NORTH, listOf(Attribute.BOND), R.string.ibar_druids_card_name, R.string.ibar_druids_card_description, R.drawable.druidzizibar),
    @SerializedName("BRIGIT") BRIGIT(5, RowInfo.ARCHERS, Fraction.NORTH, listOf(), R.string.brigit_card_name, R.string.brigit_card_description, R.drawable.brigit),
    @SerializedName("TARANIS") TARANIS(5, RowInfo.SWORDS, Fraction.NORTH, listOf(), R.string.taranis_card_name, R.string.taranis_card_description, R.drawable.taranis),
    @SerializedName("ESUS") ESUS(5, RowInfo.SWORDS, Fraction.NORTH, listOf(), R.string.esus_card_name, R.string.esus_card_description, R.drawable.esus),
    @SerializedName("GALAHAD") GALAHAD(5, RowInfo.SWORDS, Fraction.NORTH, listOf(Attribute.SPY), R.string.galahad_card_name, R.string.galahad_card_description, R.drawable.galahad),
    @SerializedName("AIBELL") AIBELL(5, RowInfo.ARCHERS, Fraction.NORTH, listOf(), R.string.aibell_card_name, R.string.aibell_card_description, R.drawable.aibell),
    @SerializedName("UTHER") UTHER(4, RowInfo.ARCHERS, Fraction.NORTH, listOf(), R.string.uther_card_name, R.string.uther_card_description, R.drawable.uther),
    @SerializedName("TALITIA") TALITIA(4, RowInfo.ARCHERS, Fraction.NORTH, listOf(), R.string.talitia_card_name, R.string.talitia_card_description, R.drawable.talitia),
    @SerializedName("ARTHWYS") ARTHWYS(4, RowInfo.SWORDS, Fraction.NORTH, listOf(Attribute.SPY), R.string.arthwys_card_name, R.string.arthwys_card_description, R.drawable.arthwys),
    @SerializedName("GRAY_LINES") GRAY_LINES(4, RowInfo.SWORDS, Fraction.NORTH, listOf(Attribute.BOND), R.string.gray_lines_card_name, R.string.gray_lines_card_description, R.drawable.szareszeregi),
    @SerializedName("GWYNEDD") GWYNEDD(2, RowInfo.SWORDS, Fraction.NORTH, listOf(), R.string.gwynedd_card_name, R.string.gwynedd_card_description, R.drawable.gwynedd),
    @SerializedName("OSTENDA_INFANTRY") OSTENDA_INFANTRY(1, RowInfo.SWORDS, Fraction.NORTH, listOf(), R.string.ostenda_infantry_card_name, R.string.ostenda_infantry_description, R.drawable.piechurzyzostendy),
    @SerializedName("ARMED_PEASANTS") ARMED_PEASANTS(1, RowInfo.SWORDS, Fraction.NORTH, listOf(Attribute.BOND), R.string.armed_peasants_card_name, R.string.armed_peasants_card_description, R.drawable.uzbrojeniwiesniacy),
    @SerializedName("POWYS") POWYS(1, RowInfo.CATAPULTS, Fraction.NORTH, listOf(Attribute.SUPPLY), R.string.powys_launcher_card_name, R.string.powys_card_description, R.drawable.powys),
    @SerializedName("OWAIN") OWAIN(1, RowInfo.CATAPULTS, Fraction.NORTH, listOf(Attribute.SPY), R.string.owain_card_name, R.string.owain_card_description, R.drawable.owain),
    ...
    @SerializedName("GOOD_WEATHER") GOOD_WEATHER(-1, RowInfo.EMPTY, Fraction.NONE, listOf(Attribute.GOOD_WEATHER), R.string.good_weather_attribute_name, R.string.good_weather_attribute_description, R.drawable.dobra_pogoda),
}
